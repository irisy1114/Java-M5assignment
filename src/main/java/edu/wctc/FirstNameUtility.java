...
public class FirstNameUtility {
    ...
    public int encodeFirstName(String firstName, String middleInitial) throws MissingNameException {
        ...
        if (firstNameCodeMap.containsKey(firstName)) {
            sum = firstNameCodeMap.get(firstName) + (middleInitial.isBlank()? 0: middleInitialCodeMap.get(middleInitial));
        } else if (firstInitialCodeMap.containsKey(firstInitial)) {
            sum = firstInitialCodeMap.get(firstInitial) + (middleInitial.isBlank()? 0: middleInitialCodeMap.get(middleInitial));
        }
